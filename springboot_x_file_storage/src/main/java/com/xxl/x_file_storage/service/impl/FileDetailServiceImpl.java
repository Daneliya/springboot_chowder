...
import com.xxl.x_file_storage.entity.FileDetail;
import com.xxl.x_file_storage.mapper.FileDetailMapper;
import com.xxl.x_file_storage.service.FileDetailService;
...
public class FileDetailServiceImpl extends ServiceImpl<FileDetailMapper, FileDetail> implements FileDetailService, FileRecorder {
    ...
    public void update(FileInfo info) {
        FileDetail detail = toFileDetail(info);
        LambdaQueryWrapper<FileDetail> qw = Wrappers.<FileDetail>lambdaQuery()
