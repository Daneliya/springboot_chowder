package com.xxl.repeat_submit.annotation.aspect;

import com.xxl.repeat_submit.annotation.SubmitLimit;
import com.xxl.repeat_submit.config.RedisLockService;
import com.xxl.repeat_submit.result.ResResult;
import com.xxl.repeat_submit.result.ResResultEnum;
import com.xxl.repeat_submit.util.JacksonUtils;
...
public class SubmitLimitAspect {
     ...
     * @return
     */
    @Around(value = "@annotation(com.xxl.repeat_submit.annotation.SubmitLimit)")
...
//        System.out.println("submitLimit" + submitLimit);
