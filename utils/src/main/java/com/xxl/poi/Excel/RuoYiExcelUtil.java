...
public class RuoYiExcelUtil<T> {
    ...
    public RuoYiExcelUtil(Class<T> clazz) {
        this.clazz = clazz;
    }
     ...
     * @throws IOException
     */
    public void exportExcel(HttpServletResponse response, Map<String, List<T>> list, String sheetName) throws IOException {
        response.setContentType("application/vnd.ms-excel");
        //response.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
        response.setCharacterEncoding("utf-8");
        // 文件名设置在header中
        ...
        for (String s : list.keySet()) {
            this.init(list.get(s), fileName, Type.EXPORT);
        }
        exportExcel(response.getOutputStream());
    }
